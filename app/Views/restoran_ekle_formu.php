...
<body>
    ...
    <?php endif; ?>
<form action="<?= site_url('restoran/kaydet') ?>" method="post" enctype="multipart/form-data">
    <?= csrf_field() ?>

    
    <label for="resim">Restoran Resmi</label>
    <input type="file" name="resim" id="resim" required>

    <label for="isim">Restoran İsmi</label>
    <input type="text" name="isim" id="isim" required>
        ...
        <input type="text" name="calisma_saatleri" id="calisma_saatleri" value="<?= set_value('calisma_saatleri') ?>">
